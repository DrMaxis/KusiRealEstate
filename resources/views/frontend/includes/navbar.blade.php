                ...
                <div role="menu" class="js-dropdown-menu navbar__dropdown navbar__dropdown--colls-2">
                  ...
                  <div class="navbar__submenu">
                    ...
                    <ul class="navbar__subnav">
                      <li class="navbar__subitem"><a href="property_details.html" class="navbar__sublink js-navbar-sublink">All Properties</a></li>
                  ...
                  <div class="navbar__submenu">
                    <h5 class="navbar__subtitle">Listing Type</h5>
                    <ul class="navbar__subnav">
